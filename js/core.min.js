...
! function(t) {
    ...
    x.ui = x.ui || {}, x.ui.version = "1.12.1",
        ...
        x.ui.focusable = function(t, e) {
            var i, n, o, s, r, l = t.nodeName.toLowerCase();
            return "area" === l ? (n = (i = t.parentNode).name, !(!t.href || !n || "map" !== i.nodeName.toLowerCase()) && (0 < (o = x("img[usemap='#" + n + "']")).length && o.is(":visible"))) : (/^(input|select|textarea|button|object)$/.test(l) ? (s = !t.disabled) && (r = x(t).closest("fieldset")[0]) && (s = !r.disabled) : s = "a" === l && t.href || e, s && x(t).is(":visible") && function(t) {
        ...
        x.fn.labels = function() {
            var t, e, i, n, o;
            return this[0].labels && this[0].labels.length ? this.pushStack(this[0].labels) : (n = this.eq(0).parents("label"), (i = this.attr("id")) && (o = (t = this.eq(0).parents().last()).add(t.length ? t.siblings() : this.siblings()), e = "label[for='" + x.ui.escapeSelector(i) + "']", n = n.add(o.find(e).addBack(e))), this.pushStack(n))
        }, x.ui.plugin = {
            add: function(t, e, i) {
         ...
         */
        W = Math.max, C = Math.abs, n = /left|center|right/, s = /top|center|bottom/, r = /[\+\-]\d+(\.[\d]+)?%?/, l = /^\w+/, a = /%$/, i = x.fn.position, x.position = {
            ...
            }(v), v[0].preventDefault && (f.at = "left top"), d = t.width, p = t.height, g = t.offset, m = x.extend({}, g), x.each(["my", "at"], function() {
                var t, e, i = (f[this] || "").split(" ");
                1 === i.length && (i = n.test(i[0]) ? i.concat(["center"]) : s.test(i[0]) ? ["center"].concat(i) : ["center", "center"]), i[0] = n.test(i[0]) ? i[0] : "center", i[1] = s.test(i[1]) ? i[1] : "center", t = r.exec(i[0]), e = r.exec(i[1]), _[this] = [t ? t[0] : 0, e ? e[0] : 0], f[this] = [l.exec(i[0])[0], l.exec(i[1])[0]]
            ...
            fit: {
                left: function(t, e) {
                    ...
                    e.collisionWidth > s ? 0 < l && a <= 0 ? (i = t.left + l + e.collisionWidth - s - o, t.left += l - i) : t.left = 0 < a && l <= 0 ? o : a < l ? o + s - e.collisionWidth : o : 0 < l ? t.left += l : 0 < a ? t.left -= a : t.left = W(t.left - r, t.left)
                },
                top: function(t, e) {
                    var i, n = e.within,
                    ...
                    e.collisionHeight > s ? 0 < l && a <= 0 ? (i = t.top + l + e.collisionHeight - s - o, t.top += l - i) : t.top = 0 < a && l <= 0 ? o : a < l ? o + s - e.collisionHeight : o : 0 < l ? t.top += l : 0 < a ? t.top -= a : t.top = W(t.top - r, t.top)
                }
            },
            flip: {
                left: function(t, e) {
                    var i, n, o = e.within,
                        ...
                        d = -2 * e.offset[0];
                    h < 0 ? ((i = t.left + f + u + d + e.collisionWidth - r - s) < 0 || i < C(h)) && (t.left += f + u + d) : 0 < c && (0 < (n = t.left - e.collisionPosition.marginLeft + f + u + d - l) || C(n) < c) && (t.left += f + u + d)
                },
                top: function(t, e) {
                    var i, n, o = e.within,
                        ...
                        d = -2 * e.offset[1];
                    h < 0 ? ((n = t.top + f + u + d + e.collisionHeight - r - s) < 0 || n < C(h)) && (t.top += f + u + d) : 0 < c && (0 < (i = t.top - e.collisionPosition.marginTop + f + u + d - l) || C(i) < c) && (t.top += f + u + d)
                }
            },
            flipfit: {
                left: function() {
    ...
    x.cleanData = (c = x.cleanData, function(t) {
        ...
        _classes: function(o) {
            ...
            function t(t, e) {
                var i, n;
                for (n = 0; n < t.length; n++) i = r.classesElementLookup[t[n]] || x(), i = o.add ? x(x.unique(i.get().concat(o.element.get()))) : x(i.not(o.element).get()), r.classesElementLookup[t[n]] = i, s.push(t[n]), e && o.classes[t[n]] && s.push(o.classes[t[n]])
            }
            return o = x.extend({
        ...
        _on: function(r, l, t) {
            var a, h = this;
            "boolean" != typeof r && (t = l, l = r, r = !1), t ? (l = a = x(l), this.bindings = this.bindings.add(l)) : (t = l, l = this.element, a = this.widget()), x.each(t, function(t, e) {
                function i() {
                    if (r || !0 !== h.options.disabled && !x(this).hasClass("ui-state-disabled")) return ("string" == typeof e ? h[e] : e).apply(h, arguments)
                }
