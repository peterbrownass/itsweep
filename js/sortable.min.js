        ...
        _contactContainers: function(t) {
            ...
            if (p)
                if (1 === this.containers.length) this.containers[f].containerCache.over || (this.containers[f]._trigger("over", t, this._uiHash(this)), this.containers[f].containerCache.over = 1);
                    ...
                    for (s = 1e4, o = null, r = (l = p.floating || this._isFloating(this.currentItem)) ? "left" : "top", n = l ? "width" : "height", c = l ? "pageX" : "pageY", i = this.items.length - 1; 0 <= i; i--) u.contains(this.containers[f].element[0], this.items[i].item[0]) && this.items[i].item[0] !== this.currentItem[0] && (h = this.items[i].item.offset()[r], a = !1, t[c] - h > this.items[i][n] / 2 && (a = !0), Math.abs(t[c] - h) < s && (s = Math.abs(t[c] - h), o = this.items[i], this.direction = a ? "up" : "down"));
